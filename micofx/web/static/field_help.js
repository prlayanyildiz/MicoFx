...
const FIELD_HELP = {
  ...
  "max_margin_usage_pct": "Tek operator dial. Kitabin tamami icin ozvarligin bu % kadarini marjin olarak kullan. Broker kaldiraci + baslangic teminati order_calc_margin ile otomatik. Yuksek = agresif. 0 = serbest marja dus.",
  "target_leverage": "Emekli (paneldisi). Eski kaldirac dial; sizing artik max_margin_usage_pct kullanir.",
  "kasa_auto_enabled": "Acik: lot+concurrent marjin %'den canli turetilir. Kapali: Gelismis kutulardaki elle degerler.",
  "lot_multiplier": "Gelismis. Kasa ON: motor canli hesabi (auto). Elle yazmak 6 saat pinler.",
  "max_concurrent_risk_pct": "Gelismis. Kasa ON: canli hesap. Elle yazmak 6 saat pin. Acik pozisyonlarin kalan 1R toplami bu yuzdeyi asacaksa yeni giris durur. 0 = kapali.",
  "size_by_edge": "Aciksa lot, holdout net R / holdout maxDD oranina gore (karekok medyan, 0.6-2.2). Pencere uzunlugu orana girmez.",
  "daily_loss_pct": "Gunluk gerceklesen zarar bakiyenin bu yuzdesini asinca yeni giris durur. 0 = kapali. Panel Sistem kartinda.",
  ...
  "card.Gunluk Limit": "Gunluk net zarar bakiyenin daily_loss_pct'sini asinca yeni giris durur; flatten her zaman acik. Sistem kartindaki Gunluk Limit alani.",
  ...
  "th.cap.Pay": "Kalan marjin butcesinden bu sembolun payi. Holdout expectancy (ve varsa canli edge_health) ile agirlikli; esit bolunmez.",
