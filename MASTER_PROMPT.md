...
is unpaid. `partial_at_r` is a second overlay (operator 25.08): **one**
...
<ROOT>/
  ...
  micofx/
    ...
    strategy.py     Params, IndicatorCache, 3 families → Signals
...
`STRATEGIES = ["mtf_pullback", "burst", "channel_break"]` — **3 canli aile**.
